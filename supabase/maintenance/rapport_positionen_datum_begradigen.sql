...
where r.organisation_id = current_organisation_id()
  and r.jahr = 2026
...
where r.id = z.rapport_id
  and r.organisation_id = current_organisation_id()
  and r.jahr = 2026
  and r.nummer = 1;             -- <<< anpassen
