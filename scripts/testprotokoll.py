...
K = [
    ...
    # ---- Nachtrag: Bereiche, die vom Umbau nicht betroffen sind, aber in
    # einer kompletten Runde nicht fehlen dürfen ----------------------------
    ("ANM", "Auf einem zweiten Gerät gleichzeitig anmelden.",
     "Beide Anmeldungen funktionieren nebeneinander."),
    ("ANM", "Sich neu registrieren (Testmandant) und den Bestätigungsweg durchspielen.",
     "Organisation entsteht, erste Anmeldung funktioniert, die Startdaten sind da."),
    ("ALG", "Auf jeder Detailseite den Rückweg benutzen (Adresse, Auftrag, Anfrage, Rapport).",
     "Es gibt überall einen Weg zurück, und er führt dorthin, wo man herkam."),
    ("ALG", "Eine Seite neu laden, während ein Filter und eine Sortierung gesetzt sind.",
     "Beides bleibt – es steht in der Adresse und nicht nur im Browser."),
    ("ANF", "Eine Anfrage mit Kanal und Priorität erfassen, dann nach beidem filtern.",
     "Die Filter greifen, die Anfrage erscheint bzw. verschwindet."),
    ("ANF", "Eine Anfrage erledigen und danach die Wiedervorlage prüfen.",
     "Sie erscheint nicht mehr in den fälligen Wiedervorlagen."),
    ("DIS", "Nach Gruppe filtern und einen Einsatz einer Gruppe zuweisen.",
     "Der Filter zeigt nur die Gruppe; die Zuweisung bleibt nach dem Neuladen."),
    ("DIS", "Eine Abwesenheit erfassen und den betroffenen Tag in der Disposition ansehen.",
     "Die Person ist an diesem Tag als abwesend erkennbar."),
    ("KAL", "Im Kalender einen Tag mit mehreren Einsätzen öffnen.",
     "Alle Einsätze des Tages stehen da, mit Kunde und Auftrag."),
    ("KAL", "Nach Mitarbeitenden filtern (als Admin).",
     "Nur die Einsätze dieser Person erscheinen."),
    ("MA", "Als Admin die Rolle einer Person ändern und mit deren Konto anmelden.",
     "Die Person sieht genau die Bereiche ihrer Rolle, nicht mehr."),
    ("MA", "Eine Abwesenheit für eine Person erfassen und im Kalender prüfen.",
     "Die Abwesenheit erscheint und blockiert die Planung, wenn die Art das vorsieht."),
    ("MA", "Bei einer Person eine Datei ablegen und als andere Person versuchen, sie zu sehen.",
     "Nur Admins und die Person selbst sehen die Ablage."),
    ("ZK", "Ferienanspruch erfassen und einen Ferientag buchen.",
     "Der Restanspruch nimmt ab, der Saldo stimmt."),
    ("ZK", "Einen Monat abschliessen und das PDF des Zeitkontos herunterladen.",
     "Das PDF zeigt Soll, Ist und Saldo des Monats."),
    ("DOK", "Eine Datei mit Umlauten und Leerzeichen im Namen hochladen und wieder herunterladen.",
     "Der Name bleibt lesbar, die Datei öffnet sich."),
    ("DOK", "Eine Datei löschen (als Admin) und die Liste neu laden.",
     "Sie ist weg, und es bleibt keine leere Zeile stehen."),
    ("BEN", "Einen Rapport per Mail versenden und den Absender prüfen.",
     "Absender und Betreff stimmen, das Logo ist im Mailkopf."),
    ("BEN", "Eine Einladung an eine falsche Adresse senden.",
     "Verständliche Rückmeldung, kein technischer Fehler."),
    ("EXP", "Zweimal denselben Zeitraum exportieren.",
     "Der zweite Lauf findet keine Positionen mehr – sie sind als exportiert markiert."),
